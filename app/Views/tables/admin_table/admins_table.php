        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div style="background:none;"><h1 style="font-weight:bold; color:black;">Admin Table</h1></div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="display:flex;  flex-direction: column;  justify-content:center; align-items:center;  width:100%;">
                        ...
                        <div style="margin-bottom:5px;">
                            <a class="btn btn-success btn-block" href="<?= base_url('/dashboard/admin/add_admin') ?>" role="button">INSERT DATA</a>        
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%;">
                                            <div style="display:inline-flex; width:100%;">
                                                    <form method="get" style="width:100%;" action="<?= base_url('/dashboard/admin_permission/edit/'.$user['id']) ?>">
