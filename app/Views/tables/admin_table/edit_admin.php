            ...
            <div class="form-group" style="width:100%; ">
                ...
                <select id="category" name="category"  style="width:100%; padding:10px; text-transform: capitalize; ">
                    <?php foreach ($roles as $role): ?>        
                        <option value="<?= $role['role_name'] ?>" <?= ($role['status'] == 1) ? $role['role_name'] : ' (Inactive)' ?> style="<?= ($role['status'] == 1) ? 'color:black;' : 'color:red;' ?> font-size:18px;  text-transform: capitalize;"> <?= ($role['status'] == 1) ? $role['role_name'] : $role['role_name'] . ' (Inactive)' ?></option>
                    <?php endforeach; ?>
                </select>
            </div> 
