...
<div style="width:100%;">
        <div>
            <div class="form-group" style="width:100%;">
                ...
                <span style="text-transform:capitalize;"><?= $admin['firstname'] ?></span>
             </div>
            ...
            <div class="form-group" style="width:100%; display:inline-flex; flex-wrap: wrap; ">
                <?php if ($permissions_2) : ?>
                    <?php foreach ($permissions_2 as $permission) : ?>
                        <form method="POST" style=" margin:5px; color:white;" action="<?= base_url('/dashboard/user_permission/delete/'.$permission['id'].'/'.$admin['id']) ?>">
            ...
            <div class="form-group" style="width:100%;">
                ...
                <form style="width:100%;"  method="POST" action="<?= base_url('/dashboard/user_permission/store/'.$admin['id']) ?>">
...
<script>
    ...
    var onceContentLoaded = function() {
         // Your code here
        //location.reload();
    };

document.addEventListener("DOMContentLoaded", onceContentLoaded);
</script>
</body>
</html>
