...
<div class="registration-form">
    <h1 style="margin-bottom: 30px;">Update Roles Permission</h1>
<div style="width:100%;">
        <div>
            <div class="form-group" style="width:100%;">
                <label for="firstname">Role Name:</label>
                <span style="text-transform:capitalize;"><?= $role['role_name'] ?></span>
             </div>
            ...
            <div class="form-group" style="width:100%; display:inline-flex; flex-wrap: wrap; ">
                <?php if ($permissions_2) : ?>
                    <?php foreach ($permissions_2 as $permission) : ?>
                        <form method="POST" style=" margin:5px; color:white;" action="<?= base_url('/dashboard/role_permission/delete/'.$permission['id'].'/'.$role['id']) ?>">
            ...
            <div class="form-group" style="width:100%;">
                ...
                <form style="width:100%;"  method="POST" action="<?= base_url('/dashboard/role_permission/store/'.$role['id']) ?>">
