        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div style="background:none;"><h1 style="font-weight:bold; color:black;">Role Table</h1></div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="display:flex;  flex-direction: column;  justify-content:center; align-items:center;  width:100%;">
                        ...
                        <div style="margin-bottom:5px; background:red; width:100%;">
                            <a class="btn btn-success btn-block" style="width:100%;" href="<?= base_url('/dashboard/role/add_role') ?>">INSERT DATA</a>        
                            ...
                            <tbody>
                                <?php foreach ($roles as $role): ?>
                                    <tr>
                                        ...
                                        <td style=" text-transform: capitalize;"><?= $role['role_name'] ?></td>
                                        <td>
                                            <?= $role['status'] ? '<span style="color:green; font-size:20px; font-weight:bold;">(Active)</span>' : '<span style="color:red; font-size:20px; font-weight:bold;">(Inactive)</span>' ?>
                                        </td>
                                        <td style="width:10%;">
                                            <div style="display:inline-flex; width:100%;">
                                                    <form method="get" style="width:100%;" action="<?= base_url('/dashboard/role_permission/edit/'.$role['id']) ?>">
                                                    ...
                                                    <form method="POST" style="width:100%;"  action="<?= base_url('/dashboard/role/delete/'.$role['id']) ?>">
